...
class GameLoop {
    ...
    async performTurn() {
        ...
        if (isPlayerTurn) {
            return _playerMove__WEBPACK_IMPORTED_MODULE_3__["default"].move(this.player.opponentBoard);
        }
        computerField.style.pointerEvents = 'none';
        return _computerMove__WEBPACK_IMPORTED_MODULE_5__["default"].move(this, this.computer.opponentBoard);
    }
